    ...
    <>
      <div className="hero grid md:grid-cols-2 items-center pt-10 xl:gap-0 gap-6 grid-cols-1">
        <div className="animate__animated animate__fadeInUp animate__delay-3s">
          ...
          <p className="text-base/loose mb-6 opacity-50">Saya mempunyai ketertarikan dalam bidang Programming dan Design, terutama pada pembuatan Website dan Design seperti design UI/UX, ketertarikan pada bidang ini sudah berlangsung sejak saya Kelas 12 di tahun 2023.</p>
          <div className="flex items-center sm:gap-4 gap-2">
            <a href="https://drive.google.com/drive/folders/1QF3_OBlSYO_EcKCqN_Vd2sTX0gEcb2lN?usp=sharing" className="bg-violet-700 p-4 rounded-2xl hover:bg-violet-500">Lihat CV <i className="ri-inbox-fill ri-lg"></i></a>
      ...
      <div className="tentang mt-32 py-10" id="tentang">
        ...
        <div className="tools mt-32">
          <h1 className="text-4xl/snug font-bold mb-4"  data-aos="fade-up" data-aos-duration="1500" data-aos-once="true">Tools yang dipakai</h1>
          <p className="xl:w-2/5 lg:w-2/4 md:w-2/3 sm:w-3/4 w-full text-base/loose opacity-50"  data-aos="fade-up" data-aos-duration="1500" data-aos-delay="300" data-aos-once="true">Berikut ini beberapa tools yang biasa saya pakai untuk pembuat Website dan Design</p>
          <div className="tools-box mt-14 grid lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-4">

          {listTools.map((tool) => (
          <div className="flex items-center gap-2 p-3 border border-zinc-600 rounded-md hover:bg-zinc-800 group" key={tool.id}  data-aos="fade-up" data-aos-duration="1500" data-aos-delay={tool.dad} data-aos-once="true">
              <img src={tool.gambar} alt="Tools Image" className="w-14 bg-zinc-800 p-1 group-hover:bg-zinc-900"></img>
              <div>
      ...
      <div className="proyek mt-32 py-10" id="proyek">
        ...
        <div className="proyek-box mt-14 grid lg:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-4">
            {listProyek.map((proyek) => (
              <div key={proyek.id} className="p-4 bg-zinc-800 rounded-md" data-aos="fade-up" data-aos-duration="1500" data-aos-delay={proyek.dad} data-aos-once="true">
                <img src={proyek.gambar} alt="Proyek Image" loading="lazy"></img>
                <div >
                  ...
                  <div className="mt-8 text-center">
                    <a href={proyek.link} className="bg-violet-700 p-3 rounded-lg block border border-zinc-600 hover:bg-violet-600">Selengkapnya</a>
                  </div>
                </div>
              </div>
            ))}
      ...
      <div className="kontak mt-32 sm:p-10 p-0" id="kontak">
        ...
        <form action="https://formsubmit.co/dc5bdead92d5c0e05aa0929641" method="POST" className="bg-zinc-800 p-10 sm:w-fit w-full mx-auto rounded-md" autoComplete="off" data-aos="fade-up" data-aos-duration="1500" data-aos-delay="500" data-aos-once="true">
    {/* Input tersembunyi untuk tujuan email */}
    <input type="hidden" name="_to" value="mraflyyydwiii@gmail.com" />
